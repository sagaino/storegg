        ...
        <div className="row mt-30 mb-20">
          <div className="col-lg-12 col-12 main-content">
            <div id="list_status_title">
              <ButtonTab onClick={() => { return onTabClick('all') }} title="All Trx" active={tab === 'all'} />
              <ButtonTab onClick={() => { return onTabClick('success') }} title="Success" active={tab === 'success'} />
              <ButtonTab onClick={() => { return onTabClick('pending') }} title="Pending" active={tab === 'pending'} />
              <ButtonTab onClick={() => { return onTabClick('failed') }} title="Failed" active={tab === 'failed'} />
            </div>
          </div>
        </div>
                ...
                {transactions.map((transaction: HistoryTransactionTypes) => {
                  return (
                    <TableRow
                      ...
                      categori={transaction.historyVoucherTopup.category}
